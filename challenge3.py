...
def retorna_pessoas_preferem_um_unico_palco(quantidade_pessoas_evento):
    ...
    perc_palco_BC = 7
    perc_palco_ABC = 3
    perc_nenhum_palco = 23
    perc_apenas_um = 35
    ingressos = input('Quantos ingressos? ')
    if ingressos == 10000:
        print(perc_apenas_um*10000//100)

retorna_pessoas_preferem_um_unico_palco(10000)            